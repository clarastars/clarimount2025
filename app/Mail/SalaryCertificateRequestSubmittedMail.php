...
class SalaryCertificateRequestSubmittedMail extends Mailable
{
    use Queueable;
    ...
    {
        return new Envelope(
            subject: __('messages.notifications.salary_certificate_request_email_subject'),
        );
    }
    ...
    public function content(): Content
    {
        ...
        return new Content(
            view: 'emails.salary-certificate-request-submitted',
            with: [
    ...
    private function buildMessageText(): string
    {
        ...
        return strtr(__('messages.notifications.salary_certificate_request_submitted'), $replacements);
    }
}
