...
/**
 * Activate Ethiopia (ETH) for nationality and residence country dropdowns.
 */
return new class extends Migration
{
    public function up(): void
    {
        $this->upsertNationalityFromLabels('ETH');
        $this->ensureCountryActive('ET', 'ETH', 'Ethiopia', 'إثيوبيا');
    }
